...
public class AdapterCartCheckout extends RecyclerView.Adapter<AdapterCartCheckout.CartCheckoutHolder> {
...
//    private int priceDryReal;
   ...
   // private int countTotalQuantity = 0;
    ...
    public AdapterCartCheckout(Context tContext, List<ModelCartView> tModels, FragmentManager tFragmentManager,
